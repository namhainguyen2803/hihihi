    ...
    class SWAEBatchTrainer:
        ...
        def eval_on_batch(self, x, y):
            ...
            if self.method == "FEFBSW":
                ...
                fsw = lowerbound_FEFBSW_list(Xs=list_z_posterior, X=z_prior, L=self.num_projections_,
                                             device=self._device)
                ...
                fsw = lowerbound_EFBSW_list(Xs=list_z_posterior, X=z_prior, L=self.num_projections_,
                                            device=self._device)
                ...
                fsw = OBSW(Xs=list_z_posterior, X=z_posterior, L=self.num_projections_, lam=1, p=2, device=self._device)
            else:
                fsw = 0
